...
# Function Call from Package

```{r}
par(pin = c(7, 3)) # Adjust graphical parameters to (slightly) increase size for plots
MATH4753PRESTONVITOSH2024::ntickets(400, 0.02, 0.95) # Call ntickets() from package
```


# Package Function File Content
